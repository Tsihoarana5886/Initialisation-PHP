    ...
    <div class="container d-flex align-items-center">
	  ...
	  <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="<?php echo site_url('Welcome/login');?>">Se Connecter</a></li>
        </ul>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2">
            <img src="assets/img/<?php echo $contenus['photo']; ?>" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1">
           ...
           <a href="contenusDetails?id=<?php echo $contenus['id'];?>"> <h3><?php echo $contenus['titre'];?></h3></a>
			...
			<a href="contenusDetails?id=<?php echo $contenus['id'];?>" class="btn-get-started scrollto">Voir details</a> |
          </div>
		  <hr>
        </div>
		<?php } ?>
		<p>
			<ul class="swiper-pagination">
				<li><a href="index?numeropage=1">1</a></li>
				<li class="active"><a href="index?numeropage=2">2</a></li>
			</ul>
		</p>
      </div>
    </section>
