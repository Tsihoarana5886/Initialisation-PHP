    ...
    <div class="container d-flex align-items-center">
	  ...
	  <nav id="navbar" class="navbar">
        <ul>
		  ...
		  <li><a class="nav-link scrollto active" href="<?php echo site_url('Welcome/listeContenus');?>">Listes Contenus</a></li>
      ...
      <div class="container">
		...
		<p>
			<ul class="swiper-pagination">
				<li><a href="listeContenus?numeropage=1">1</a></li>
				<li class="active"><a href="listeContenus?numeropage=2">2</a></li>
			</ul>
		</p>
      </div>
    </section>
