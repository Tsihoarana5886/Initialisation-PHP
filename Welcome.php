...
class Welcome extends CI_Controller {
	...
	public function contenusDetails()
	{
		$this->load->model('Crud_model');
	...
	public function connexionAdmin()
	{
		...
		else
		{
			...
			$this->load->view('pagebackoffice',$data);
		}
	 }
	...
	{
		$this->load->view('ajoutBackoffice');
	}
	...
	public function modifierContenus()
	{
		...
		$contenus=$this->Crud_model->getById($id);
		$data['contenus']= $contenus;
		$this->load->view('modifierBackoffice',$data);
	}
	...
	public function listeContenus()
	{
		...
		$contenus=$this->Crud_model->listeContenus($numeropage);
		$data['contenus']= $contenus;
		$this->load->view('listeBackoffice',$data);
	}
	public function detailsBackOffice()
	{
		...
		$contenus=$this->Crud_model->getById($id);
		$data['contenus']= $contenus;
		$this->load->view('detailsBackoffice',$data);
	}
}
